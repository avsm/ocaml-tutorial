...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0f4a7ba642795c2ea19ad97e34288f11) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "echo1.ml"; });
               Executable
                 ({
                     cs_name = "heads";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "heads.ml"; });
               Executable
                 ({
                     cs_name = "sleep";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sleep.ml"; });
               Executable
                 ({
                     cs_name = "mysleep";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "mysleep.ml"; })
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "H½F¹í\145\027ù\n\131\030\157ÐiW\157";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
